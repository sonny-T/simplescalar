...
cache_create(char *name,		/* name of the cache */
	     ...
	     enum cache_assoc_type assoc_type,
...
/* parse assoc_type */
enum cache_assoc_type
cache_char2type(char assoc_type)
{
  switch (assoc_type) {
  case 's': return SetA;
  case 'p': return PseudoA;
  default: fatal("bogus replacement policy, `%c'", assoc_type);
  }
}
